...
CREATE TABLE IF NOT EXISTS `flink_position_name` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `poster_location_city` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lid` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `alias` varchar(255) NOT NULL,
...
--
-- Table structure for table `slider_supplier`
--

CREATE TABLE IF NOT EXISTS `slider_supplier` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `image` varchar(255) NOT NULL,
  `serial` int(11) NOT NULL,
...
--
-- Dumping data for table `slider_supplier`
--

INSERT INTO `slider_supplier` (`id`, `name`, `image`, `serial`, `status`) VALUES
(1, 'Thrifly', 'img5.png', 5, 1),
(2, 'National', 'img6.png', 10, 1);
...
INSERT INTO `sub_menu` (`id`, `mid`, `name`, `s_alias`, `links`, `serial`, `last_action_date`, `last_action_user`, `status`) VALUES
(1, 1, 'About', 'about', '', 5, '2013-10-12 02:53:25', 1, 0),
(2, 1, 'sub two', 'sub-two', '', 10, '2013-10-12 02:53:29', 1, 0);
