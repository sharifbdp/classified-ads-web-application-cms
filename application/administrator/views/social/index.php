            ...
            <img src="<?php echo base_url(); ?>image/delet.png" width="16" height="16" border="0" /></a>
                            ...
                            <td height="25" bordercolor="#FF0000" class="table_border" style="border-top:none; "><div align="center">
                                    ...
                                    <?php if ($elearning['status'] == '0') { ?>
                                        <a href="<?php echo base_url(); ?>social/active/<?php echo $elearning['id'] ?>" onClick="return confirm('Are you sure?');"><img src="<?php echo base_url(); ?>image/status.png" width="17" height="16" border="0" /></a>
                                        <?php
                                    }
                                    if ($elearning['status'] == '1') {
                                        ?>

                                        <a href="<?php echo base_url(); ?>social/inactive/<?php echo $elearning['id'] ?>" onClick="return confirm('Are you sure?');"><img src="<?php echo base_url(); ?>image/un_publi.png" width="17" height="16" border="0" / ></a>
                                    <?php } ?>
                                </div></td>
                        </tr>
