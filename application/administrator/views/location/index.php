    ...
    <div align="center">
        <div class="inner_mid" >
            <div class="top_bar" >
                ...
                <div class="top_bar_left" > All Location/Place </div>
                <div class="top_bar_right">
                    <div class="top_menu">
                        <ul>
                            <li>
                                <a href="<?php echo base_url(); ?>location/add" id="add"  title="Add new main location"  ><img src="<?php echo base_url(); ?>image/new.jpg" title="Add new" />
                                    <p> New </p>
                                </a>
                            </li>
                            <li>
            ...
            <div class="down_list">
                ...
                <table width="96%" border="0" align="center" cellpadding="1" cellspacing="0" style="color:#333333">
                    ...
                    <tr style="font-weight:bold; background:url(<?php echo base_url(); ?>image/table_top_bg.jpg) repeat-x top #E0E0E0; border:#AFAFAF solid 1px;">
                        ...
                        <td width="230" height="25" class="table_border" style="border-right:none;"><div align="center" class="style2">Location Name</div></td>
                    ...
                    foreach ($main_categorys as $menu):
                        ...
                        <tr bgcolor="<?php echo $cl; ?>">
                            ...
                            <td height="25" bordercolor="#FF0000" class="table_border" style="border-top:none; border-right:none;"><div align="center">
                                    <a href="<?php echo base_url(); ?>location/edit/<?php echo $menu['id']; ?>" onClick="return confirm('Are you sure?');">
                                        <img src="<?php echo base_url(); ?>image/edit.png" width="15" height="16" border="0" />	</a>
                                </div></td>
                            <td height="25" bordercolor="#FF0000" class="table_border" style="border-top:none; border-right:none;"><div align="center">
                                    <a href="<?php echo base_url(); ?>location/delete/<?php echo $menu['id']; ?>" onClick="return confirm('Are you sure?');">
                            ...
                            <td height="25" bordercolor="#FF0000" class="table_border" style="border-top:none; "><div align="center">
                                    ...
                                    <?php if ($menu['status'] == '0') { ?>
                                        <a href="<?php echo base_url(); ?>location/active/<?php echo $menu['id'] ?>" onClick="return confirm('Are you sure?');"><img src="<?php echo base_url(); ?>image/status.png" width="17" height="16" border="0" /></a>
                                        <?php
                                    }
                                    if ($menu['status'] == '1') {
                                        ?>

                                        <a href="<?php echo base_url(); ?>location/inactive/<?php echo $menu['id'] ?>" onClick="return confirm('Are you sure?');"><img src="<?php echo base_url(); ?>image/un_publi.png" width="17" height="16" border="0" / ></a>
                                    <?php } ?>
                                </div></td>
                        </tr>
