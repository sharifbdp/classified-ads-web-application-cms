                        ...
                        <tr bgcolor="<?php echo $cl; ?>">
                            ...
                            <td height="25" bordercolor="#FF0000" class="table_border" style="border-top:none; "><div align="center">
                                    ...
                                    <?php if ($menu['status'] == '0') { ?>
                                        <a href="<?php echo base_url(); ?>location/active/<?php echo $menu['id'] ?>" onClick="return confirm('Are you sure?');"><img src="<?php echo base_url(); ?>image/un_publi.png" width="17" height="16" border="0" /></a>
                                        <?php
                                    }
                                    if ($menu['status'] == '1') {
                                        ?>

                                        <a href="<?php echo base_url(); ?>location/inactive/<?php echo $menu['id'] ?>" onClick="return confirm('Are you sure?');"><img src="<?php echo base_url(); ?>image/status.png" width="17" height="16" border="0" / ></a>
                                    <?php } ?>
                                </div></td>
                        </tr>
