    ...
    <div align="center">
        <div class="inner_mid" >
            <div class="top_bar" >
                ...
                <div class="top_bar_left" > Edit City/Area </div>
            ...
            <div class="add_down_list">
                ...
                <table width="900" border="0" align="center" cellpadding="5" cellspacing="0">
                            ...
                            <select name="lid">
                                ...
                                if ($all_location) {
                                    foreach ($all_location as $loc) {
                                        $selected = ($loc['id'] == $content->lid) ? 'selected=selected' : '';
                                        ?>
                    ...
                    <tr>
                        <td width="225" height="25"><div align="right" class="table_title" ><strong>Area Name:</strong> </div></td>
