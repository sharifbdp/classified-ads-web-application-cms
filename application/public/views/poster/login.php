...
<li class='current'><a href="/en/users/log_in"><span>Log in</span></a></li>
</ul>
...
<a href="/en/users/sign_up">Sign up now!</a>
</p>
</div>
<div class='col5 polar'>
<div class='tabs'>
<a class='active tab' href='/en/users/log_in'>
Log in
</a>
<a class='tab' href='/en/users/sign_up'>
Sign up
</a>
</div>
<div class='form-box'>
...
<input class="required xl" id="user_password" name="user[password]" placeholder="Password" size="30" type="password" />
</div>
</div>
<div class='field'>
<div class='input'>
<label>
<input name="user[remember]" type="hidden" value="0" /><input id="user_remember" name="user[remember]" type="checkbox" value="1" />
Remember me
</label>
...
<a href="/en/users/password/new">Forgot password?</a>
</form>
