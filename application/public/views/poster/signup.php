...
<meta content="Y/lHDtel/ctQs+0l3h7AQJaARDFSXjKJQrCm9UOWUts=" name="csrf-token" />
...
<a href="/en/users/log_in">Log in here</a>
</p>
</div>
<div class='col5 polar'>
<div class='tabs'>
<a class='tab' href='/en/users/log_in'>
Log in
</a>
<a class='active tab' href='/en/users/sign_up'>
Sign up
</a>
</div>
<div class='form-box'>
...
<form accept-charset="UTF-8" action="/en/users" class="new_user" id="new_user" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Y/lHDtel/ctQs+0l3h7AQJaARDFSXjKJQrCm9UOWUts=" /></div><input id="user_site_id" name="user[site_id]" type="hidden" value="4" />
<div class='field input poster-types'>
<label>
<input checked="checked" id="user_poster_type_private" name="user[poster_type]" type="radio" value="private" />
Private
</label>
<label>
<input id="user_poster_type_business" name="user[poster_type]" type="radio" value="business" />
Business advertiser
</label>
</div>
<div class='field'>
<div class='input'>
<input class="required xl" id="user_name" name="user[name]" placeholder="Name" size="30" type="text" />
</div>
</div>
<div class='field'>
<div class='input'>
<input class="required email xl" id="user_email" name="user[email]" placeholder="Email" size="30" type="text" />
</div>
</div>
<div class='field'>
<div class='input'>
<input class="required xl" id="user_password" minlength="5" name="user[password]" placeholder="Password" size="30" type="password" />
</div>
</div>
<div class='field'>
<div class='input'>
<input class="required xl" id="user_password_confirmation" name="user[password_confirmation]" placeholder="Confirm password" size="30" type="password" />
</div>
</div>
<div class='field'>
<div class='terms'>
By signing up for an account you agree to our <a href="/en/terms" data-ui-nav="modal">Terms &amp; Conditions</a>
</div>
...
<script>
  ...
  Config = {
    ...
    EM_SESSION_ID: '444f752f576053973961b5baff9c4eea'
  };
