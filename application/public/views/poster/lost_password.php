...
<form accept-charset="UTF-8" action="/en/a-picture-for-sale-greater-accra/generate_password_link" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Y/lHDtel/ctQs+0l3h7AQJaARDFSXjKJQrCm9UOWUts=" /></div>
<div class='inner-box'>
...
<input name='user[site_id]' type='hidden' value='4'>
<div class='field'>
<label for='email'>
Your email:
</label>
<div class='input'>
<input class='email' id='email' name='user[email]' type='text'>
</div>
</div>
